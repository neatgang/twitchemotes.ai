...
export async function POST(
  ...
  //   return new NextResponse("Resolution is required", { status: 400 });
    ...
    const finalPrompt = `Design a Super Deformed (SD) style Twitch emote featuring '${prompt}'. Emphasize the playful and exaggerated aspects of the design using super deformed proportions—large heads and small bodies—and vibrant colors. Ensure the emote maintains clarity and expressiveness at smaller sizes for optimal visibility in Twitch chat.`
